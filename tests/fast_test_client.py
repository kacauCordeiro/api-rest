...
Cookies = typing.Union[typing.MutableMapping[str, str], requests.cookies.RequestsCookieJar]
...
class _ASGIAdapter(requests.adapters.HTTPAdapter):
    ...
    def send(
        ...
        headers += [
            (key.lower().encode(), value.encode() if isinstance(value, str) else value)
...
class TestClient(requests.Session):
    ...
    def __enter__(self) -> "TestClient":
        with contextlib.ExitStack() as stack:
            ...
            self.stream_send = StapledObjectStream(*anyio.create_memory_object_stream(math.inf))
            self.stream_receive = StapledObjectStream(*anyio.create_memory_object_stream(math.inf))
